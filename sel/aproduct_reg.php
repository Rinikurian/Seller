...
if (isset($_POST['signup'])) {
  ...
  $description = strtoupper($_POST['description']);
    ...
    $sql1 = "INSERT INTO `product`(`productname`, `productimage`,`subcategoryid`,`price`,`quantity`,`description`,`status`) VALUES ('$productname','$m','$subcategoryid','$price','$quantity','$description',1)";
...
<form name="form1" class="form-horizontal" enctype="multipart/form-data" method="post" action="" onsubmit="return ValidationEvent()">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input  type="file"  name="photo" id="photo" class="form-control input-md"  onchange="fileCheckk(this)" required="">
         ...
         <div class="form-group">
            ...
            <div class="col-md-4">
                <input  type="numberr"  name="price" id="price" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input  type="number"  name="quantity" id="quantity" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <button class="btn btn-primary" id="btn_Product_reg1" onclick="location.href = 'astaff_home.php';" style="float: right;">Back</button>
            </div>
        </div>
