...
if (isset($_POST['signup'])) {
    ...
    $sql1 = "INSERT INTO `invoice`( `date`,`due`, `Item`, `specification`, `cost`, `qty`, `price`, `subtotal`, `total`, `paid`, `balancedue`, `status`) VALUES ( '$date','$due','$Item','$specification','$cost','$qty','$price','$subtotal','$total','$paid','$balancedue',1)";
                ...
                <table id="items">
                    ...
                    <tr class="item-row">
                        <td class="item-name"><div class="delete-wpr"><textarea name="Item" id="Item" placeholder="Enter Product name" required onkeypress="return onlyAlphabets(event,this);" ></textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div></td>
                                                            ...
                                                            <td class="description"><textarea name="specification" id="specification" placeholder="Enter the specification"  required></textarea></td>
    ...
    <td><textarea class="price" name="price" id="price" onkeypress="javascript:return isNumber(event)">$.00</textarea></td>
                                                            ...
                                                            <div id="terms">
                                                                <input type="submit" name="signup" value="Print" id="signup" class="btn btn-success">
                                                                    <button class="btn btn-primary" id="" onclick="location.href = 'onlinepay.php';" style="float: right;">Pay</button>&nbsp &nbsp &nbsp
                                                                    <button class="btn btn-primary" id="" onclick="location.href = 'product_view.php';" style="float: right;">Back to products</button>&nbsp&nbsp&nbsp
