...
if (isset($_POST['signup'])) {
    ...
    $category_select =strtoupper($_POST['category_select']);
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="submit" name="signup" value="SAVE" id="signup" class="btn btn-success">
                   <button class="btn btn-primary" id="" name="btn_Product_reg" onclick="location.href = 'astaff_home.php';" style="float: right;">Back</button>
            </div>
