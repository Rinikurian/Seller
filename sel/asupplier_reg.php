...
<form name="form1" class="form-horizontal" enctype="multipart/form-data" method="post" action="" onsubmit="return addUser()">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="mobile" name="mobile" type="varchar" placeholder="Enter mobile number" class="form-control input-md" required onChange="return gPhone()">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="gstnumber" name="gstnumber" type="number" placeholder="Enter gstnumber" class="form-control input-md" required="">
